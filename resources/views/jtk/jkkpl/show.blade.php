                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-2">
                                        <select name="tindakan" id="tindakan"
                                            class="form-control text-uppercase form-control-md" disabledbbb>
                                            <option value="">Sila Pilih</option>
                                ...
                                <div class="row mb-3">
                                    <label for="" class="col-sm-3 col-form-label col-form-label-md" readonly>
                                        Jenis Tindakan
                                    </label>
                                    <div class="col-sm-6">
                                        <input type="text" name="jenisTindakan" id="" class="form-control form-control-md"
                                            readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="tahunTindakan" id="" class="form-control form-control-md"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <div class="col">
                                        <textarea name="" id="" cols="30" rows="10" class="form-control" readonly>Sila masukkan ulasan</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <a href="#ulasanTatatertib" class="d-block card-header py-3" data-toggle="collapse" role="button"
                    ...
                    <small class="text-muted">31. b.
                        Bahagian Khidmat Pengurusan</small>
                </a>
                <div class="collapse show" id="ulasanTatatertib">
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <label for="" class="col-sm-3 col-form-label col-form-label-md">Markah LNPT (3
                                        Tahun)</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="markah" id="" class="form-control form-control-md"
                                            placeholder="Tahun" readonly>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" name="markah" id="" class="form-control form-control-md"
                                            placeholder="Markah" readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <span for="" class="col-sm-3 col-form-label col-form-label-md"></span>
                                    <div class="col-sm-2">
                                        <input type="text" name="markah" id="" class="form-control form-control-md"
                                            placeholder="Tahun" readonly>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <label for="" class="col-sm-3 col-form-label col-form-label-md">
                                        Anugerah Perkhidmatan Kecemerlangan
                                    </label>
                                    <div class="col-sm-2">
                                        <input type="text" name="tahun" id="" class="form-control form-control-md"
                                            placeholder="Tahun" readonly>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="collapse show" id="ulasanTatatertib">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <label for="" class="col-sm-1 col-form-label col-form-label-md">Tarikh</label>
                                    <div class="col-sm-2">
                                        <input type="date" name="tarikh" id="" class="form-control form-control-md"
                                            value="{{ date('mm-dd-Y') }}" readonly>
                                    </div>
                                    <label for="" class="col-sm-2 col-form-label col-form-label-sm">Tandatangan</label>
                                    <div class="col-sm-2">
                                        <input type="file" name="tandatangan" id="" class="form-control form-control-md"
                                            readonly>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <a href="#ulasanTatatertib" class="d-block card-header py-3" data-toggle="collapse" role="button"
                    aria-expanded="true" aria-controls="ulasanTatatertib">
                    <h6 class="m-0 font-weight-bold text-primary text-capitalize">Seksyen H -
                        Jawatankuasa Perancang dan Penyelarasan Latihan (JKPPL) JUPEM</h6>
                    </h6>
                </a>
                <div class="collapse show" id="ulasanTatatertib">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <label for="" class="col-sm-2 col-form-label col-form-label-md">Tarikh Terima
                                        Permohonan</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-2">
                                        <input type="text" name="tarikhTerimaPermohonan" id=""
                                            class="form-control form-control-md"
                                            value="{{ $pengakuan->tarikhPengakuan }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="" class="col-sm-2 col-form-label col-form-label-md">Status</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-2">
                                        <select name="statusPermohonan" id="statusPermohonan"
                                            class="form-control form-control-md">
                                            <option value="">Sila Pilih</option>
                                ...
                                <div class="row mb-3" id="alasanDitolak">
                                    <label for="" class="col-sm-2 col-form-label col-form-label-md">Ditolak kerana</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-9 row">
                                        <div class="form-check mx-2">
                                            <input class="form-check-input" type="checkbox" value="1"
                                                id="borangTidakLengkap">
                                            <label class="form-check-label" for="borangTidakLengkap">
                                                Borang tidak lengkap
                                            </label>
                                        </div>
                                        <div class="form-check mx-2">
                                            <input class="form-check-input" type="checkbox" value="2" id="tiadaPengesahan">
                                            <label class="form-check-label" for="tiadaPengesahan">
                                                Tiada pengesahan Ketua Jabatan/Bahagian
                                            </label>
                                        </div>
                                        <div class="form-check mx-2">
                                            <input class="form-check-input" type="checkbox" value="3" id="permohonanLewat">
                                            <label class="form-check-label" for="permohonanLewat">
                                                Permohonan lewat diterima
                                            </label>
                                        </div>
                                        <div class="form-check mx-2">
                                            <input class="form-check-input" type="checkbox" value="4" id="lain">
                                            <label class="form-check-label" for="lain">
                                                Lain-lain (Sila nyatakan di bawah)
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <label for="" class="col-sm-2 col-form-label col-form-label-md">Ulasan</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-9">
                                ...
                                <div class="row mb-3">
                                    <label for="" class="col-sm-2 col-form-label col-form-label-md">Tarikh Maklum kepada
                                        Pemohon</label>
                                    <span class="col-sm-1">:</span>
                                    <div class="col-sm-2">
                                        <input type="date" name="tarikhMaklum" id="" class="form-control form-control-md">
                                    </div>
                                </div>
                            </div>
                        </div>
