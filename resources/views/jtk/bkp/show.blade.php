                    ...
                    <div class="card-body">
                            ...
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <label for="" class="col-sm-3 col-form-label col-form-label-md">Pemohon pernah
                                        ...
                                        tindakan?</label>
                                    <div class="col-sm-2">
                                        <input type="text" name="" id="" class="form-control form-control-md"
                                            value="{{ $utt->tindakan }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="jenisTindakan" id="" class="form-control form-control-md"
                                            value="{{ $utt->jenisTindakan }}" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="row mb-3">
                                    <div class="col">
                                        <textarea name="" id="" cols="30" rows="10" class="form-control" disabled>{{ $utt->ulasan }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="collapse show" id="ulasanTatatertib">
                    <div class="card-body">
                        <form action="/bkp/simpan" method="post">
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <div class="row mb-3">
                                        @csrf
