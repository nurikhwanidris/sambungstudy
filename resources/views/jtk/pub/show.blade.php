    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="collapse show" id="ulasanTatatertib">
                    <div class="card-body">
                        <form action="/pub/save" method="post" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    <div class="row mb-3">
                                        <div class="col">
                                            <textarea name="" id="" cols="30" rows="10" class="form-control">Sila masukkan ulasan</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="file" name="tandatangan" id=""
